...
namespace CobelHR.Entities.Base.PMS
{
    ...
    {
        public static Info Informer { get; } = new Info("Base.PMS", "IndividualDevelopmentPlanAction", "Individual Development Plan Action");
        ...
        public IndividualDevelopmentPlanAction(int id, byte[] timeStamp) : base(id, timeStamp, IndividualDevelopmentPlanAction.Informer)
        {
