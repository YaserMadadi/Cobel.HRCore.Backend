...
namespace CobelHR.ApiServices.Controllers.Base.PMS
{
    ...
    public class CurrentSituationController : BaseController
    {
        ...
        public IActionResult CollectionOfIndividualDevelopmentPlan([FromRoute(Name = "currentSituation_id")] int id, IndividualDevelopmentPlanAction individualDevelopmentPlan)
        {
