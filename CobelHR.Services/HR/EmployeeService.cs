...
namespace CobelHR.Services.HR
{
    public class EmployeeService : Service<Employee>, IEmployeeService
    {
        ...
        public DataResult<List<Assessment>> CollectionOfAssessment(int employee_Id, Assessment assessment)
        {
		...
		public DataResult<List<BehavioralAppraise>> CollectionOfBehavioralAppraise_Appraiser(int employee_Id, BehavioralAppraise behavioralAppraise)
        {
		...
		public DataResult<List<Coaching>> CollectionOfCoaching(int employee_Id, Coaching coaching)
        {
		...
		public DataResult<List<Contract>> CollectionOfContract(int employee_Id, Contract contract)
        {
		...
		public DataResult<List<CriticalIncident>> CollectionOfCriticalIncident(int employee_Id, CriticalIncident criticalIncident)
        {
		...
		public DataResult<List<CriticalIncidentRecognition>> CollectionOfCriticalIncidentRecognition_Writer(int employee_Id, CriticalIncidentRecognition criticalIncidentRecognition)
        {
		...
		public DataResult<List<EmployeeDetail>> CollectionOfEmployeeDetail(int employee_Id, EmployeeDetail employeeDetail)
        {
		...
		public DataResult<List<EmployeeEvent>> CollectionOfEmployeeEvent(int employee_Id, EmployeeEvent employeeEvent)
        {
		...
		public DataResult<List<EmployeeNotification>> CollectionOfEmployeeNotification(int employee_Id, EmployeeNotification employeeNotification)
        {
		...
		public DataResult<List<FunctionalAppraise>> CollectionOfFunctionalAppraise_Appraiser(int employee_Id, FunctionalAppraise functionalAppraise)
        {
		...
		public DataResult<List<FunctionalKPIComment>> CollectionOfFunctionalKPIComment_Commenter(int employee_Id, FunctionalKPIComment functionalKPIComment)
        {
		...
		public DataResult<List<FunctionalObjectiveComment>> CollectionOfFunctionalObjectiveComment_Commenter(int employee_Id, FunctionalObjectiveComment functionalObjectiveComment)
        {
		...
		public DataResult<List<Impersonate>> CollectionOfImpersonate(int employee_Id, Impersonate impersonate)
        {
		...
		public DataResult<List<PositionAssignment>> CollectionOfPositionAssignment(int employee_Id, PositionAssignment positionAssignment)
        {
		...
		public DataResult<List<QualitativeAppraise>> CollectionOfQualitativeAppraise_Appraiser(int employee_Id, QualitativeAppraise qualitativeAppraise)
        {
		...
		public DataResult<List<RoleMember>> CollectionOfRoleMember(int employee_Id, RoleMember roleMember)
        {
		...
		public DataResult<List<TargetSetting>> CollectionOfTargetSetting(int employee_Id, TargetSetting targetSetting)
        {
		...
		public DataResult<List<Training>> CollectionOfTraining(int employee_Id, Training training)
        {
		...
		public DataResult<List<Vision>> CollectionOfVision(int employee_Id, Vision vision)
        {
		...
		public DataResult<List<VisionApproved>> CollectionOfVisionApproved_ByEmployee(int employee_Id, VisionApproved visionApproved)
        {
		...
		public DataResult<List<VisionComment>> CollectionOfVisionComment_Commentator(int employee_Id, VisionComment visionComment)
        {
