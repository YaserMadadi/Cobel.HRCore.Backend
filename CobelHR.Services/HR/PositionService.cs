...
namespace CobelHR.Services.HR
{
    public class PositionService : Service<Position>, IPositionService
    {
        ...
        public DataResult<List<Position>> CollectionOfPosition_Parent(int position_Id, Position position)
        {
		...
		public DataResult<List<PositionAssignment>> CollectionOfPositionAssignment(int position_Id, PositionAssignment positionAssignment)
        {
		...
		public DataResult<List<PromotionAssessment>> CollectionOfPromotionAssessment_ProposedPosition(int position_Id, PromotionAssessment promotionAssessment)
        {
		...
		public DataResult<List<PromotionAssessment>> CollectionOfPromotionAssessment_CurrentPosition(int position_Id, PromotionAssessment promotionAssessment)
        {
		...
		public DataResult<List<RotationAssessment>> CollectionOfRotationAssessment_ProposedPosition(int position_Id, RotationAssessment rotationAssessment)
        {
		...
		public DataResult<List<RotationAssessment>> CollectionOfRotationAssessment_CurrentPosition(int position_Id, RotationAssessment rotationAssessment)
        {
		...
		public DataResult<List<TargetSetting>> CollectionOfTargetSetting(int position_Id, TargetSetting targetSetting)
        {
		...
		public DataResult<List<Vision>> CollectionOfVision(int position_Id, Vision vision)
        {
