...
namespace CobelHR.Services.HR
{
    public class AbilityLevelService : Service<AbilityLevel>, IAbilityLevelService
    {
        ...
        public DataResult<List<LanguageAbility>> CollectionOfLanguageAbility_ListeningLevel(int abilityLevel_Id, LanguageAbility languageAbility)
        {
		...
		public DataResult<List<LanguageAbility>> CollectionOfLanguageAbility_SpeackingLevel(int abilityLevel_Id, LanguageAbility languageAbility)
        {
		...
		public DataResult<List<LanguageAbility>> CollectionOfLanguageAbility_ReadingLevel(int abilityLevel_Id, LanguageAbility languageAbility)
        {
		...
		public DataResult<List<LanguageAbility>> CollectionOfLanguageAbility_WritingLevel(int abilityLevel_Id, LanguageAbility languageAbility)
        {
