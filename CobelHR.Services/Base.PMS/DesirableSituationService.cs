...
namespace CobelHR.Services.Base.PMS
{
    public class DesirableSituationService : Service<DesirableSituation>, IDesirableSituationService
    {
        ...
        public DataResult<List<IndividualDevelopmentPlan>> CollectionOfIndividualDevelopmentPlan(int desirableSituation_Id, IndividualDevelopmentPlan individualDevelopmentPlan)
        {
