...
namespace CobelHR.Services.Base.PMS.Abstract
{
    ...
    {
        DataResult<List<IndividualDevelopmentPlan>> CollectionOfIndividualDevelopmentPlan(int currentSituation_Id, IndividualDevelopmentPlan individualDevelopmentPlan);
    }
}
