...
namespace CobelHR.Services.LAD
{
    public class AssessmentService : Service<Assessment>, IAssessmentService
    {
        ...
        public DataResult<List<AssessmentCoaching>> CollectionOfAssessmentCoaching(int assessment_Id, AssessmentCoaching assessmentCoaching)
        {
		...
		public DataResult<List<AssessmentScore>> CollectionOfAssessmentScore(int assessment_Id, AssessmentScore assessmentScore)
        {
		...
		public DataResult<List<AssessmentTraining>> CollectionOfAssessmentTraining(int assessment_Id, AssessmentTraining assessmentTraining)
        {
		...
		public DataResult<List<CoachingQuestionary>> CollectionOfCoachingQuestionary(int assessment_Id, CoachingQuestionary coachingQuestionary)
        {
		...
		public DataResult<List<Conclusion>> CollectionOfConclusion(int assessment_Id, Conclusion conclusion)
        {
		...
		public DataResult<List<DevelopmentGoal>> CollectionOfDevelopmentGoal(int assessment_Id, DevelopmentGoal developmentGoal)
        {
		...
		public DataResult<List<FeedbackSession>> CollectionOfFeedbackSession(int assessment_Id, FeedbackSession feedbackSession)
        {
		...
		public DataResult<List<PromotionAssessment>> CollectionOfPromotionAssessment(int assessment_Id, PromotionAssessment promotionAssessment)
        {
		...
		public DataResult<List<RotationAssessment>> CollectionOfRotationAssessment(int assessment_Id, RotationAssessment rotationAssessment)
        {
