...
namespace CobelHR.Services.LAD
{
    public class CoachService : Service<Coach>, ICoachService
    {
        ...
        public DataResult<List<CoachConnectionLine>> CollectionOfCoachConnectionLine(int coach_Id, CoachConnectionLine coachConnectionLine)
        {
		...
		public DataResult<List<Coaching>> CollectionOfCoaching(int coach_Id, Coaching coaching)
        {
