...
namespace CobelHR.Services.LAD
{
    public class AnswerTypeService : Service<AnswerType>, IAnswerTypeService
    {
        ...
        public DataResult<List<AnswerTypeItem>> CollectionOfAnswerTypeItem(int answerType_Id, AnswerTypeItem answerTypeItem)
        {
		...
		public DataResult<List<QuestionaryItem>> CollectionOfQuestionaryItem(int answerType_Id, QuestionaryItem questionaryItem)
        {
