...
namespace CobelHR.Services.PMS
{
    public class CompetencyItemService : Service<CompetencyItem>, ICompetencyItemService
    {
        ...
        public DataResult<List<AssessmentScore>> CollectionOfAssessmentScore(int competencyItem_Id, AssessmentScore assessmentScore)
        {
		...
		public DataResult<List<BehavioralObjective>> CollectionOfBehavioralObjective(int competencyItem_Id, BehavioralObjective behavioralObjective)
        {
		...
		public DataResult<List<CompetencyItemKPI>> CollectionOfCompetencyItemKPI(int competencyItem_Id, CompetencyItemKPI competencyItemKPI)
        {
		...
		public DataResult<List<DevelopmentPlanCompetency>> CollectionOfDevelopmentPlanCompetency(int competencyItem_Id, DevelopmentPlanCompetency developmentPlanCompetency)
        {
