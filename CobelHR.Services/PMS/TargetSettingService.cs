...
namespace CobelHR.Services.PMS
{
    public class TargetSettingService : Service<TargetSetting>, ITargetSettingService
    {
        ...
        public DataResult<List<AppraiseResult>> CollectionOfAppraiseResult(int targetSetting_Id, AppraiseResult appraiseResult)
        {
		...
		public DataResult<List<BehavioralObjective>> CollectionOfBehavioralObjective(int targetSetting_Id, BehavioralObjective behavioralObjective)
        {
		...
		public DataResult<List<FinalAppraise>> CollectionOfFinalAppraise(int targetSetting_Id, FinalAppraise finalAppraise)
        {
		...
		public DataResult<List<FunctionalObjective>> CollectionOfFunctionalObjective(int targetSetting_Id, FunctionalObjective functionalObjective)
        {
		...
		public DataResult<List<QualitativeObjective>> CollectionOfQualitativeObjective(int targetSetting_Id, QualitativeObjective qualitativeObjective)
        {
		...
		public DataResult<List<QuantitativeAppraise>> CollectionOfQuantitativeAppraise(int targetSetting_Id, QuantitativeAppraise quantitativeAppraise)
        {
