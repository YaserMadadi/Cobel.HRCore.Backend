...
namespace CobelHR.Services.PMS
{
    public class FunctionalObjectiveService : Service<FunctionalObjective>, IFunctionalObjectiveService
    {
        ...
        public DataResult<List<FunctionalKPI>> CollectionOfFunctionalKPI(int functionalObjective_Id, FunctionalKPI functionalKPI)
        {
		...
		public DataResult<List<FunctionalObjective>> CollectionOfFunctionalObjective_ParentalFunctionalObjective(int functionalObjective_Id, FunctionalObjective functionalObjective)
        {
		...
		public DataResult<List<FunctionalObjectiveComment>> CollectionOfFunctionalObjectiveComment(int functionalObjective_Id, FunctionalObjectiveComment functionalObjectiveComment)
        {
